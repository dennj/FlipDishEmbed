...
import React17, { useState as useState6, useRef as useRef4, useEffect as useEffect6 } from "react";
...
var FlipDishContext = createContext(null);
function FlipDishProvider({ config, children }) {
  ...
  const initiateOTP = useCallback(async (phone, captchaToken) => {
    try {
  ...
  const updateBasket = useCallback(async (action) => {
    if (!sessionId) return;
    try {
  ...
  const addMenuItems = useCallback((newItems) => {
  ...
  const placeOrder = useCallback(async (paymentAccountId) => {
    let authToken = token;
    if (!authToken) {
  ...
  return /* @__PURE__ */ jsx(FlipDishContext.Provider, { value, children });
}
...
// src/components/FlipDishChat.tsx
import { Send, ShoppingCart, LogIn, LogOut, Loader2 as Loader23, X as X2, ChevronLeft, User, CreditCard, Check as Check2, Plus as Plus2, Minus } from "lucide-react";
...
function createSlot(ownerName) {
  ...
  const Slot2 = React4.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx3(SlotClone, { ...slotProps, ref: forwardedRef, children: React4.isValidElement(newElement) ? React4.cloneElement(newElement, void 0, newChildren) : null });
    }
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx8(
      AvatarProvider,
      {
        ...
        children: /* @__PURE__ */ jsx8(Primitive.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? /* @__PURE__ */ jsx8(Primitive.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
...
var AvatarFallback = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? /* @__PURE__ */ jsx8(Primitive.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
var Avatar2 = React12.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx9(
  Root,
  {
    ref,
    className: cn(
...
var AvatarImage2 = React12.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx9(
  Image,
  {
    ref,
...
var AvatarFallback2 = React12.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx9(
  Fallback,
  {
    ref,
    className: cn(
...
import { Plus, Loader2 as Loader22, Check } from "lucide-react";
...
var DialogOverlay = React14.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx11(
...
var DialogContent = React14.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs2(DialogPortal, { children: [
...
var DialogTitle = React14.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx11(
...
var DialogDescription = React14.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx11(
...
function MenuItemOptionModal({ isOpen, onClose, item }) {
  ...
  const [currentSetIndex, setCurrentSetIndex] = useState4(0);
  ...
  return /* @__PURE__ */ jsx12(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxs3(DialogContent, { className: "sm:max-w-[425px]", children: [
    /* @__PURE__ */ jsxs3(DialogHeader, { children: [
      /* @__PURE__ */ jsx12(DialogTitle, { children: item.name }),
      /* @__PURE__ */ jsxs3(DialogDescription, { children: [
        currentSet.optionSetId,
        currentSet.required && /* @__PURE__ */ jsx12("span", { className: "text-destructive ml-1", children: "*" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs3("div", { className: "grid gap-4 py-4 max-h-[60vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsx12("div", { className: "grid gap-2", children: currentSet.options.map((option, idx) => /* @__PURE__ */ jsxs3(
        Button,
        {
          variant: "outline",
          ...
          disabled: isAdding,
          children: [
            /* @__PURE__ */ jsx12("span", { children: option.name }),
            option.price && option.price > 0 && /* @__PURE__ */ jsxs3("span", { className: "text-muted-foreground", children: [
              "+",
    ...
    /* @__PURE__ */ jsxs3(DialogFooter, { className: "flex flex-row justify-between sm:justify-between w-full", children: [
      /* @__PURE__ */ jsx12("div", { className: "flex-1", children: currentSetIndex > 0 && /* @__PURE__ */ jsxs3(Button, { variant: "ghost", onClick: handleBack, disabled: isAdding, className: "gap-1 pl-0", children: [
        /* @__PURE__ */ jsx12(ArrowLeft2, { className: "w-4 h-4" }),
        "Back"
      ] }) }),
      /* @__PURE__ */ jsx12("div", { className: "flex-1 flex justify-end", children: isOptional && /* @__PURE__ */ jsx12(Button, { variant: "secondary", onClick: handleSkip, disabled: isAdding, children: currentSetIndex < optionSets.length - 1 ? "Skip" : "Add Without" }) })
    ] })
  ] }) });
}
...
function MenuItemCard({ item, compact = false }) {
  ...
  const [isAdded, setIsAdded] = useState5(false);
  ...
  return /* @__PURE__ */ jsxs4(Fragment3, { children: [
    /* @__PURE__ */ jsxs4(Card, { className: "w-full bg-card border shadow-sm hover:shadow-md transition-all h-full flex flex-col", children: [
      /* @__PURE__ */ jsx13("div", { className: "aspect-[4/3] relative overflow-hidden bg-muted rounded-t-lg", children: item.imageUrl ? /* @__PURE__ */ jsx13(
        "img",
        {
          src: item.imageUrl,
          alt: item.name,
      ...
      ) : /* @__PURE__ */ jsx13("div", { className: "w-full h-full flex items-center justify-center text-muted-foreground bg-primary/5", children: /* @__PURE__ */ jsx13("span", { className: "text-3xl font-bold opacity-30", children: item.name.charAt(0).toUpperCase() }) }) }),
      /* @__PURE__ */ jsxs4(CardContent, { className: "p-3 space-y-1 flex-1", children: [
        /* @__PURE__ */ jsx13(CardTitle, { className: "text-sm font-semibold truncate", title: item.name, children: item.name }),
        /* @__PURE__ */ jsxs4("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx13("span", { className: "text-sm font-medium text-primary", children: item.price.toFixed(2) }),
          item.menuSectionName && /* @__PURE__ */ jsx13("span", { className: "text-[10px] text-muted-foreground uppercase truncate max-w-[80px]", children: item.menuSectionName })
        ] }),
        item.description && /* @__PURE__ */ jsx13("p", { className: "text-xs text-muted-foreground line-clamp-2 min-h-[2.5em]", children: item.description })
      ] }),
      /* @__PURE__ */ jsx13(CardFooter, { className: "p-3 pt-0 mt-auto", children: /* @__PURE__ */ jsx13(
        Button,
        {
          size: "sm",
          ...
          onClick: handleAdd,
          disabled: isLoading,
          children: isLoading ? /* @__PURE__ */ jsx13(Loader22, { className: "w-3 h-3 animate-spin" }) : isAdded ? /* @__PURE__ */ jsxs4(Fragment3, { children: [
            /* @__PURE__ */ jsx13(Check, { className: "w-3 h-3" }),
            "Added"
          ] }) : /* @__PURE__ */ jsxs4(Fragment3, { children: [
            /* @__PURE__ */ jsx13(Plus, { className: "w-3 h-3" }),
...
function MenuItemCarousel({ items }) {
  ...
  return /* @__PURE__ */ jsxs4(
    Carousel,
    {
      ...
      children: [
        /* @__PURE__ */ jsx13(CarouselContent, { className: "-ml-2 md:-ml-4", children: items.map((item) => /* @__PURE__ */ jsx13(CarouselItem, { className: "pl-2 md:pl-4 basis-[55%] sm:basis-[45%] md:basis-[40%]", children: /* @__PURE__ */ jsx13(MenuItemCard, { item }) }, item.menuItemId)) }),
        items.length > 2 && /* @__PURE__ */ jsxs4(Fragment3, { children: [
          /* @__PURE__ */ jsx13(CarouselPrevious, { className: "hidden sm:flex -left-4 w-8 h-8" }),
          /* @__PURE__ */ jsx13(CarouselNext, { className: "hidden sm:flex -right-4 w-8 h-8" })
        ] })
      ]
    }
  );
...
function AuthModal({ isOpen, onClose, onSuccess }) {
  ...
  const [phone, setPhone] = useState6("");
  const [code, setCode] = useState6("");
  const [step, setStep] = useState6("phone");
  ...
  return /* @__PURE__ */ jsx14("div", { className: "absolute inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4", children: /* @__PURE__ */ jsxs5(Card, { className: "w-full max-w-sm shadow-lg animate-in fade-in zoom-in-95 duration-200", children: [
    /* @__PURE__ */ jsxs5(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      /* @__PURE__ */ jsx14(CardTitle, { className: "text-xl", children: "Sign In" }),
      /* @__PURE__ */ jsx14(Button, { variant: "ghost", size: "icon", onClick: onClose, className: "h-8 w-8 p-0", children: /* @__PURE__ */ jsx14(X2, { className: "h-4 w-4" }) })
    ] }),
    /* @__PURE__ */ jsx14(CardContent, { className: "pt-4", children: step === "phone" ? /* @__PURE__ */ jsxs5("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsx14("p", { className: "text-sm text-muted-foreground", children: "Enter your phone number to receive a verification code" }),
      /* @__PURE__ */ jsxs5("div", { className: "space-y-2", children: [
        ...
        error && /* @__PURE__ */ jsx14("p", { className: "text-destructive text-xs", children: error })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx14(Button, { variant: "outline", className: "flex-1", onClick: onClose, children: "Cancel" }),
        /* @__PURE__ */ jsxs5(Button, { className: "flex-1", onClick: handleSendCode, disabled: loading || !phone, children: [
          loading ? /* @__PURE__ */ jsx14(Loader23, { className: "w-4 h-4 animate-spin mr-2" }) : null,
          "Send Code"
        ] })
      ] })
    ] }) : /* @__PURE__ */ jsxs5("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxs5(Button, { variant: "link", className: "px-0 h-auto text-muted-foreground", onClick: () => setStep("phone"), children: [
        /* @__PURE__ */ jsx14(ChevronLeft, { className: "w-4 h-4 mr-1" }),
        "Back"
      ] }),
      /* @__PURE__ */ jsxs5("p", { className: "text-sm text-muted-foreground", children: [
        "Enter the 4-digit code sent to ",
        /* @__PURE__ */ jsx14("span", { className: "font-medium text-foreground", children: phone })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx14(
          Input,
        ...
        error && /* @__PURE__ */ jsx14("p", { className: "text-destructive text-xs", children: error }),
        loading && /* @__PURE__ */ jsxs5("div", { className: "flex items-center justify-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsx14(Loader23, { className: "w-4 h-4 animate-spin" }),
          /* @__PURE__ */ jsx14("span", { children: "Verifying..." })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx14(HCaptcha, { ref: captchaRef, sitekey: HCAPTCHA_SITE_KEY, size: "invisible" })
  ] }) });
}
function BasketPanel({ isOpen, onClose, onSignInNeeded }) {
  ...
  const [isPlacingOrder, setIsPlacingOrder] = React17.useState(false);
  const [updatingItemId, setUpdatingItemId] = React17.useState(null);
...
Order ID: ${orderId}`;
  ...
  if (!isOpen) return null;
  return /* @__PURE__ */ jsx14("div", { className: "absolute inset-0 bg-background/80 backdrop-blur-sm flex items-end justify-center z-50", children: /* @__PURE__ */ jsxs5(Card, { className: "w-full max-h-[85%] flex flex-col rounded-b-none border-b-0 shadow-xl animate-in slide-in-from-bottom duration-300", children: [
    /* @__PURE__ */ jsxs5(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 border-b", children: [
      /* @__PURE__ */ jsx14(CardTitle, { children: "Your Basket" }),
      /* @__PURE__ */ jsx14(Button, { variant: "ghost", size: "icon", onClick: onClose, className: "h-8 w-8 p-0", children: /* @__PURE__ */ jsx14(X2, { className: "h-4 w-4" }) })
    ] }),
    /* @__PURE__ */ jsx14("div", { className: "flex-1 overflow-y-auto p-4", children: basketItems.length === 0 ? /* @__PURE__ */ jsxs5("div", { className: "text-center py-12 space-y-4", children: [
      /* @__PURE__ */ jsx14("div", { className: "bg-muted w-16 h-16 rounded-full flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsx14(ShoppingCart, { className: "w-8 h-8 text-muted-foreground" }) }),
      /* @__PURE__ */ jsx14("p", { className: "text-muted-foreground", children: "Your basket is empty" })
    ] }) : /* @__PURE__ */ jsx14("div", { className: "space-y-4", children: basketItems.map((item, idx) => /* @__PURE__ */ jsx14("div", { className: "flex justify-between items-start pb-4 border-b last:border-0 last:pb-0", children: /* @__PURE__ */ jsxs5("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxs5("div", { className: "flex justify-between", children: [
        /* @__PURE__ */ jsx14("p", { className: "font-medium text-sm", children: item.name }),
        /* @__PURE__ */ jsx14("p", { className: "font-semibold text-sm text-right", children: item.totalPrice.toFixed(2) })
      ] }),
      item.menuItemOptionSetItems && item.menuItemOptionSetItems.length > 0 && /* @__PURE__ */ jsx14("p", { className: "text-xs text-muted-foreground mt-1", children: item.menuItemOptionSetItems.map((opt) => opt.name).join(", ") }),
      /* @__PURE__ */ jsx14("div", { className: "flex items-center gap-3 mt-3", children: /* @__PURE__ */ jsxs5("div", { className: "flex items-center border rounded-md shadow-sm bg-background", children: [
        /* @__PURE__ */ jsx14(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx14(Minus, { className: "w-3 h-3" })
          }
        ),
        /* @__PURE__ */ jsx14("span", { className: "text-xs font-medium w-6 text-center", children: updatingItemId === idx ? /* @__PURE__ */ jsx14(Loader23, { className: "w-3 h-3 animate-spin mx-auto" }) : item.quantity }),
        /* @__PURE__ */ jsx14(
          "button",
          {
            className: "p-1 px-2 hover:bg-muted text-muted-foreground transition-colors disabled:opacity-50",
            onClick: () => handleUpdateQuantity(item, 1, idx),
            disabled: updatingItemId === idx,
            children: /* @__PURE__ */ jsx14(Plus2, { className: "w-3 h-3" })
          }
        )
      ] }) })
    ] }) }, idx)) }) }),
    basketItems.length > 0 && /* @__PURE__ */ jsxs5("div", { className: "p-4 border-t bg-muted/20", children: [
      /* @__PURE__ */ jsxs5("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsx14("span", { className: "text-muted-foreground", children: "Total" }),
        /* @__PURE__ */ jsx14("span", { className: "text-xl font-bold", children: basketTotal.toFixed(2) })
      ] }),
      isAuthenticated && defaultPaymentAccount && /* @__PURE__ */ jsxs5("p", { className: "text-xs text-muted-foreground mb-4", children: [
        "Payment: ",
        defaultPaymentAccount.Description
      ] }),
      error && /* @__PURE__ */ jsx14("div", { className: "mb-4 p-3 bg-destructive/10 border border-destructive/20 rounded-md", children: /* @__PURE__ */ jsx14("p", { className: "text-xs text-destructive font-medium", children: error }) }),
      /* @__PURE__ */ jsx14(Button, { className: "w-full", onClick: handleCheckout, disabled: isPlacingOrder, children: isPlacingOrder ? /* @__PURE__ */ jsxs5(Fragment4, { children: [
        /* @__PURE__ */ jsx14(Loader23, { className: "w-4 h-4 animate-spin mr-2" }),
        "Processing..."
...
function PaymentMethodPanel({ isOpen, onClose }) {
  ...
  return /* @__PURE__ */ jsx14("div", { className: "absolute inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4", children: /* @__PURE__ */ jsxs5(Card, { className: "w-full max-w-sm shadow-lg animate-in fade-in zoom-in-95 duration-200", children: [
    /* @__PURE__ */ jsxs5(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      /* @__PURE__ */ jsx14(CardTitle, { className: "text-xl", children: "Payment Methods" }),
      /* @__PURE__ */ jsx14(Button, { variant: "ghost", size: "icon", onClick: onClose, className: "h-8 w-8 p-0", children: /* @__PURE__ */ jsx14(X2, { className: "h-4 w-4" }) })
    ] }),
    /* @__PURE__ */ jsxs5(CardContent, { className: "pt-4 space-y-4", children: [
      /* @__PURE__ */ jsx14("div", { className: "space-y-2", children: paymentAccounts.length === 0 ? /* @__PURE__ */ jsx14("p", { className: "text-sm text-muted-foreground text-center py-4", children: "No payment methods found" }) : paymentAccounts.map((account) => {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx14("div", { className: "bg-muted p-2 rounded-full", children: /* @__PURE__ */ jsx14(CreditCard, { className: "w-4 h-4 text-muted-foreground" }) }),
                /* @__PURE__ */ jsx14("div", { className: "flex flex-col", children: /* @__PURE__ */ jsx14("span", { className: "text-sm font-medium", children: account.Description }) })
              ] }),
              isSelected && /* @__PURE__ */ jsx14(Check2, { className: "w-4 h-4 text-primary" })
            ]
          },
          account.PaymentAccountId
        );
      }) }),
      /* @__PURE__ */ jsxs5(Button, { variant: "destructive", className: "w-full", onClick: handleLogout, children: [
        /* @__PURE__ */ jsx14(LogOut, { className: "w-4 h-4 mr-2" }),
        "Log Out"
      ] })
    ] })
  ] }) });
...
function FlipDishChat() {
  ...
  const [showAuth, setShowAuth] = useState6(false);
  const [showProfile, setShowProfile] = useState6(false);
  const [returnToBasket, setReturnToBasket] = useState6(false);
  ...
  const renderMessageContent = (msg) => {
    if (msg.role === "user") {
      return /* @__PURE__ */ jsx14("div", { className: "flex flex-col gap-1 items-end", children: /* @__PURE__ */ jsx14("div", { className: "bg-primary text-primary-foreground rounded-2xl rounded-br-sm px-5 py-3 text-sm shadow-sm", children: /* @__PURE__ */ jsx14("p", { className: "whitespace-pre-wrap leading-relaxed", children: msg.content }) }) });
    }
    if (msg.role === "tool") {
      try {
        const content = JSON.parse(msg.content);
        if (content.displayType === "menu_cards" && content.items?.length > 0) {
          return /* @__PURE__ */ jsx14("div", { className: "w-full pl-11 mb-2", children: /* @__PURE__ */ jsx14(MenuItemCarousel, { items: content.items }) });
        }
      } catch (e) {
        return null;
      }
    ...
    if (msg.role === "assistant") {
      ...
      return /* @__PURE__ */ jsxs5("div", { className: "flex gap-3 max-w-[85%] animate-in fade-in slide-in-from-bottom-2 duration-300", children: [
        /* @__PURE__ */ jsxs5(Avatar2, { className: "h-8 w-8 mt-1 border shadow-sm bg-card", children: [
          /* @__PURE__ */ jsx14(AvatarImage2, { src: "/placeholder-logo.png" }),
          /* @__PURE__ */ jsx14(AvatarFallback2, { className: "bg-background text-[10px] font-bold text-muted-foreground", children: "AI" })
        ] }),
        /* @__PURE__ */ jsx14("div", { className: "flex flex-col gap-1", children: /* @__PURE__ */ jsx14("div", { className: "bg-card text-card-foreground border rounded-2xl rounded-bl-sm px-5 py-3 text-sm shadow-sm overflow-hidden prose prose-sm dark:prose-invert max-w-none leading-relaxed break-words [&>p]:mb-2 [&>p:last-child]:mb-0 [&>ul]:list-disc [&>ul]:pl-4 [&>ol]:list-decimal [&>ol]:pl-4", children: /* @__PURE__ */ jsx14(
          ReactMarkdown,
          {
            remarkPlugins: [remarkGfm],
            components: {
              // Use defaults but ensure links open in new tab
              a: (props) => /* @__PURE__ */ jsx14("a", { target: "_blank", rel: "noopener noreferrer", className: "text-primary underline underline-offset-2 hover:text-primary/80", ...props })
            },
  ...
  if (!isInitialized) {
    return /* @__PURE__ */ jsxs5("div", { className: "flex flex-col h-full bg-background items-center justify-center space-y-4", children: [
      /* @__PURE__ */ jsx14(Loader23, { className: "w-8 h-8 animate-spin text-primary" }),
      /* @__PURE__ */ jsx14("p", { className: "text-sm text-muted-foreground font-medium", children: "Connecting..." })
    ] });
  }
  return /* @__PURE__ */ jsxs5(Card, { className: "flex flex-col h-full rounded-xl border shadow-lg overflow-hidden bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60", children: [
    /* @__PURE__ */ jsxs5(CardHeader, { className: "flex flex-row items-center justify-between p-4 border-b space-y-0 text-left bg-card/50", children: [
      /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxs5(Avatar2, { className: "h-10 w-10 border-2 border-background shadow-sm", children: [
          /* @__PURE__ */ jsx14(AvatarImage2, { src: "/placeholder-logo.png" }),
          /* @__PURE__ */ jsx14(AvatarFallback2, { className: "bg-primary text-primary-foreground font-semibold", children: restaurantStatus?.restaurantName?.charAt(0) || "F" })
        ] }),
        /* @__PURE__ */ jsxs5("div", { className: "flex flex-col gap-0.5", children: [
          /* @__PURE__ */ jsx14(CardTitle, { className: "text-base font-semibold leading-none", children: "FlipDish" }),
          /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-1.5", children: [
            ...
            ), children: /* @__PURE__ */ jsx14("span", { className: cn(
              "animate-ping absolute inline-flex h-2 w-2 rounded-full opacity-75",
              isRestaurantOpen ? "bg-green-400" : "bg-red-400"
            ) }) }),
            /* @__PURE__ */ jsx14(CardDescription, { className: "text-xs font-medium", children: isRestaurantOpen ? "Online & Ordering" : "Currently Closed" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxs5(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsx14(ShoppingCart, { className: "h-4 w-4" }),
              basketItems.length > 0 && /* @__PURE__ */ jsx14("span", { className: "absolute -top-1 -right-1 h-5 w-5 bg-primary text-primary-foreground text-[10px] font-bold flex items-center justify-center rounded-full border-2 border-background shadow-sm", children: basketItems.length })
            ]
          }
        ),
        isAuthenticated ? /* @__PURE__ */ jsx14(
          Button,
          {
            variant: "ghost",
            size: "icon",
            ...
            children: /* @__PURE__ */ jsx14(User, { className: "h-4 w-4 text-muted-foreground" })
          }
        ) : /* @__PURE__ */ jsx14(
          Button,
          {
            ...
            title: "Sign in",
            className: "h-9 w-9 rounded-full",
            children: /* @__PURE__ */ jsx14(LogIn, { className: "h-4 w-4 text-muted-foreground" })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxs5(CardContent, { className: "flex-1 overflow-y-auto p-4 space-y-6 bg-muted/10 scroll-smooth", ref: scrollRef, children: [
      visibleMessages.map((msg, idx) => {
        ...
        return /* @__PURE__ */ jsx14(React17.Fragment, { children: renderMessageContent(msg) }, idx);
      }),
      isLoading && /* @__PURE__ */ jsxs5("div", { className: "flex gap-3 max-w-[85%] animate-pulse", children: [
        /* @__PURE__ */ jsx14(Avatar2, { className: "h-8 w-8 mt-1 border shadow-sm", children: /* @__PURE__ */ jsx14(AvatarFallback2, { className: "bg-background text-[10px]", children: "AI" }) }),
        /* @__PURE__ */ jsxs5("div", { className: "bg-card border rounded-2xl rounded-bl-sm px-5 py-4 shadow-sm flex items-center gap-1.5 w-20", children: [
          /* @__PURE__ */ jsx14("span", { className: "w-1.5 h-1.5 bg-foreground/30 rounded-full animate-bounce [animation-delay:-0.3s]" }),
          /* @__PURE__ */ jsx14("span", { className: "w-1.5 h-1.5 bg-foreground/30 rounded-full animate-bounce [animation-delay:-0.15s]" }),
          /* @__PURE__ */ jsx14("span", { className: "w-1.5 h-1.5 bg-foreground/30 rounded-full animate-bounce" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx14(CardFooter, { className: "p-4 bg-background border-t", children: /* @__PURE__ */ jsxs5(
      "form",
      {
        onSubmit: (e) => {
          e.preventDefault();
        ...
        children: [
          /* @__PURE__ */ jsx14("div", { className: "relative flex-1", children: /* @__PURE__ */ jsx14(
            Input,
            {
              ref: inputRef,
              value: input,
          ...
          /* @__PURE__ */ jsxs5(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsx14(Send, { className: "h-5 w-5" }),
                /* @__PURE__ */ jsx14("span", { className: "sr-only", children: "Send" })
              ]
            }
          )
        ]
